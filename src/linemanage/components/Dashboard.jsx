...
const Dashboards = React.memo(() => {
  return (
    <div className="font-sans flex justify-between h-auto sm:flex-col sm:pr-2 sm:w-full  md:flex-row  flex-wrap lg:flex-nowrap   lg:items-stretch  border-b-2 border-t-2 mx-1 mt-20 ">
      <LineManagera />
